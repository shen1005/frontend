...
<template>
    <div class="product_line">
        <ProductInterface v-show="colNum > 0" :row="row" col="1" ref="product1"></ProductInterface>
        <ProductInterface v-show="colNum > 1" :row="row" col="2" ref="product2"></ProductInterface>
        <ProductInterface v-show="colNum > 2" :row="row" col="3" ref="product3"></ProductInterface>
        <ProductInterface v-show="colNum > 3" :row="row" col="4" ref="product4"></ProductInterface>
        <ProductInterface v-show="colNum > 4" :row="row" col="5" ref="product5"></ProductInterface>
    </div>
</template>
